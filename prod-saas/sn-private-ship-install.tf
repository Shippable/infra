...
resource "aws_instance" "ms_5" {
  ...
  tags = {
    Name = "ms_5_${var.install_version}"
  }
}
...
resource "aws_instance" "ms_7" {
  ...
  tags = {
    Name = "ms_7_${var.install_version}"
  }
}

# instance MS-6
resource "aws_instance" "ms_8" {
  ami = "${var.ami_us_east_1_ubuntu1404}"
  availability_zone = "${var.avl-zone}"
  instance_type = "${var.in_type_ms}"
  key_name = "${var.aws_key_name}"
  ...
  tags = {
    Name = "ms_8_${var.install_version}"
  }
}

# instance MS-9
resource "aws_instance" "ms_9" {
  ami = "${var.ami_us_east_1_ubuntu1404}"
  availability_zone = "${var.avl-zone}"
  instance_type = "${var.in_type_ms}"
  key_name = "${var.aws_key_name}"
  ...
  tags = {
    Name = "ms_9_${var.install_version}"
  }
}

# instance MS-10
resource "aws_instance" "ms_10" {
  ami = "${var.ami_us_east_1_ubuntu1404}"
  availability_zone = "${var.avl-zone}"
  instance_type = "${var.in_type_ms}"
  key_name = "${var.aws_key_name}"
  ...
  tags = {
    Name = "ms_10_${var.install_version}"
  }
}
