...
resource "aws_instance" "test_instance_centos_7_rituraj_1" {
  ...
  tags = {
    Name = "test_instance_centos_7_rituraj_1"
  }
}

output "test_instance_centos_7_rituraj_1" {
  value = "${aws_instance.test_instance_centos_7_rituraj_1.private_ip}"
}

## RHEL 7 test instance Rituraj
resource "aws_instance" "rituraj_x86_64_rhel7_new_1" {
  ...
  tags = {
    Name = "rituraj_x86_64_rhel7_new_1"
  }
}

output "rituraj_x86_64_rhel7_new_1" {
  value = "${aws_instance.rituraj_x86_64_rhel7_new_1.private_ip}"
}
...
resource "aws_instance" "test_instance_vijay_u1604" {
  ami = "${var.ami_us_east_1_ubuntu1604}"
  availability_zone = "${var.avl-zone}"
  instance_type = "${var.in_type_core}"
  key_name = "${var.aws_key_name}"
  ...
  tags = {
    Name = "test_instance_vijay_u1604_${var.install_version}"
  }
}

output "test_instance_vijay_u1604" {
  value = "${aws_instance.test_instance_vijay_u1604.private_ip}"
}

resource "aws_instance" "test_instance_bindu_u1604" {
  ami = "${var.ami_us_east_1_ubuntu1604}"
  availability_zone = "${var.avl-zone}"
  instance_type = "${var.in_type_core}"
  key_name = "${var.aws_key_name}"
  ...
  tags = {
    Name = "test_instance_bindu_u1604_${var.install_version}"
  }
}

output "test_instance_bindu_u1604" {
  value = "${aws_instance.test_instance_bindu_u1604.private_ip}"
}

resource "aws_instance" "test_instance_ranjan_u1604" {
  ami = "${var.ami_us_east_1_ubuntu1604}"
  availability_zone = "${var.avl-zone}"
  instance_type = "${var.in_type_core}"
  key_name = "${var.aws_key_name}"
  ...
  tags = {
    Name = "test_instance_ranjan_u1604_${var.install_version}"
  }
}

output "test_instance_ranjan_u1604" {
  value = "${aws_instance.test_instance_ranjan_u1604.private_ip}"
}
