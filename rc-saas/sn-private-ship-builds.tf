...
resource "aws_instance" "grisham_dev_instance_ric03uec_u1404" {
  ...
  tags = {
    Name = "grisham_dev_instance_ric03uec_u1404_${var.install_version}"
  }
}

output "grisham_dev_instance_ric03uec_u1404" {
  value = "${aws_instance.grisham_dev_instance_ric03uec_u1404.private_ip}"
}
...
resource "aws_instance" "grisham_dev_instance_ric03uec_u1604_02" {
  ami = "${var.ami_us_east_1_ubuntu1604}"
  availability_zone = "${var.avl-zone}"
  instance_type = "${var.in_type_core}"
  key_name = "${var.aws_key_name}"
  ...
  tags = {
    Name = "grisham_dev_instance_ric03uec_u1604_${var.install_version}_02"
  }
}

output "grisham_dev_instance_ric03uec_u1604_02" {
  value = "${aws_instance.grisham_dev_instance_ric03uec_u1604_02.private_ip}"
}
