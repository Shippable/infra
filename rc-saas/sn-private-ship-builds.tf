...
resource "aws_instance" "shrivara_x86_64_u1604" {
  ami = "${var.ami_us_east_1_ubuntu1604}"
  availability_zone = "${var.avl-zone}"
  instance_type = "${var.in_type_core}"
  key_name = "${var.aws_key_name}"
  ...
  tags = {
    Name = "shrivara_x86_64_u1604_${var.install_version}"
  }
}

output "shrivara_x86_64_u1604" {
  value = "${aws_instance.shrivara_x86_64_u1604.private_ip}"
}

resource "aws_instance" "shrivara_x86_64_c7" {
  ...
  tags = {
    Name = "shrivara_x86_64_c7_${var.install_version}"
  }
}

output "shrivara_x86_64_c7" {
  value = "${aws_instance.shrivara_x86_64_c7.private_ip}"
}
