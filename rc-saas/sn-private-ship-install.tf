...
resource "aws_instance" "test_3_u1404" {
  ami = "${var.ami_us_east_1_ubuntu1404}"
  availability_zone = "${var.avl-zone}"
  instance_type = "${var.in_type_core}"
  key_name = "${var.aws_key_name}"
  ...
  tags = {
    Name = "test_3_u1404_${var.install_version}"
  }
}

output "test_3_u1404" {
  value = "${aws_instance.test_3_u1404.private_ip}"
}

resource "aws_instance" "test_4_u1404" {
  ami = "${var.ami_us_east_1_ubuntu1404}"
  availability_zone = "${var.avl-zone}"
  instance_type = "${var.in_type_core}"
  key_name = "${var.aws_key_name}"
  ...
  tags = {
    Name = "test_4_u1404_${var.install_version}"
  }
}

output "test_4_u1404" {
  value = "${aws_instance.test_4_u1404.private_ip}"
}
