...
##resource "aws_instance" "test_inst_1_centos_7" {
...
##
##  tags = {
##    Name = "test_inst_1_centos_7_${var.install_version}"
##  }
##}
##
##output "test_inst_1_centos_7" {
##  value = "${aws_instance.test_inst_1_centos_7.private_ip}"
##}

resource "aws_instance" "grisham_test_u1604" {
  ami = "${var.ami_us_east_1_ubuntu1604}"
  availability_zone = "${var.avl-zone}"
  instance_type = "${var.in_type_core}"
  key_name = "${var.aws_key_name}"
  ...
  tags = {
    Name = "grisham_test_u1604_${var.install_version}"
  }
}

output "grisham_test_u1604" {
  value = "${aws_instance.grisham_test_u1604.private_ip}"
}

resource "aws_instance" "grisham_machine_u1604_bharath" {
  ami = "${var.ami_us_east_1_ubuntu1604}"
  availability_zone = "${var.avl-zone}"
  instance_type = "${var.in_type_core}"
  key_name = "${var.aws_key_name}"
  ...
  tags = {
    Name = "grisham_machine_u1604_bharath_${var.install_version}"
  }
}

output "grisham_machine_u1604_bharath" {
  value = "${aws_instance.grisham_machine_u1604_bharath.private_ip}"
}

resource "aws_instance" "grisham_test_machine_u1604_1" {
  ami = "${var.ami_us_east_1_ubuntu1604}"
  availability_zone = "${var.avl-zone}"
  instance_type = "${var.in_type_core}"
  key_name = "${var.aws_key_name}"
  ...
  tags = {
    Name = "grisham_test_machine_u1604_1_${var.install_version}"
  }
}

output "grisham_test_machine_u1604_1" {
  value = "${aws_instance.grisham_test_machine_u1604_1.private_ip}"
}

resource "aws_instance" "grisham_test_machine_u1604_2" {
  ami = "${var.ami_us_east_1_ubuntu1604}"
  availability_zone = "${var.avl-zone}"
  instance_type = "${var.in_type_core}"
  key_name = "${var.aws_key_name}"
  ...
  tags = {
    Name = "grisham_test_machine_u1604_2_${var.install_version}"
  }
}

output "grisham_test_machine_u1604_2" {
  value = "${aws_instance.grisham_test_machine_u1604_2.private_ip}"
}

resource "aws_instance" "grisham_test_machine_u1604_3" {
  ami = "${var.ami_us_east_1_ubuntu1604}"
  availability_zone = "${var.avl-zone}"
  instance_type = "${var.in_type_core}"
  key_name = "${var.aws_key_name}"
  ...
  tags = {
    Name = "grisham_test_machine_u1604_3_${var.install_version}"
  }
}

output "grisham_test_machine_u1604_3" {
  value = "${aws_instance.grisham_test_machine_u1604_3.private_ip}"
}
...
resource "aws_instance" "grisham_machine_u1604_jatin" {
  ami = "${var.ami_us_east_1_ubuntu1604}"
  availability_zone = "${var.avl-zone}"
  instance_type = "${var.in_type_core}"
  key_name = "${var.aws_key_name}"
  ...
  tags = {
    Name = "grisham_machine_u1604_jatin_${var.install_version}"
  }
}

output "grisham_machine_u1604_jatin" {
  value = "${aws_instance.grisham_machine_u1604_jatin.private_ip}"
}
