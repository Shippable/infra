...
resource "aws_instance" "image_builder_1_u1604" {
  ...
  tags = {
    Name = "image_builder_1_u1604_${var.install_version}"
  }
}

output "image_builder_1_u1604" {
  value = "${aws_instance.image_builder_1_u1604.private_ip}"
}
