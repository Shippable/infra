...
# # varsha: x86/64 Ubuntu 16 Instances
...
#   value = "${formatlist("instance %v has private ip %v", aws_instance.admiral_varsha_u1604.*.id, aws_instance.admiral_varsha_u1604.*.private_ip)}"
# }

# bindu: x86/64 Ubuntu 16 Instances
resource "aws_instance" "admiral_bindu_u1604" {
  ami = "${var.ami_us_east_1_ubuntu1604}"
  availability_zone = "${var.avl-zone}"
  instance_type = "${var.in_type_ms_x}"
  key_name = "${var.aws_key_name}"
  ...
  tags = {
    Name = "admiral_bindu_u1604_${count.index}_${var.install_version}"
  }
}

output "admiral_bindu_u1604" {
  value = "${formatlist("instance %v has private ip %v", aws_instance.admiral_bindu_u1604.*.id, aws_instance.admiral_bindu_u1604.*.private_ip)}"
}
...
## vishnu:  x86/64 WindowsServer 2019
# resource "aws_instance" "admiral_vishnu_win19" {
...
#   }
#   tags = {
#     Name = "admiral_vishnu_win19_${count.index}_${var.install_version}"
#   }
# }
# output "admiral_vishnu_win19" {
#   value = "${formatlist("instance %v has private ip %v", aws_instance.admiral_vishnu_win19.*.id, aws_instance.admiral_vishnu_win19.*.private_ip)}"
# }
...
## varsha: x86/64 Ubuntu 18 Instances
#resource "aws_instance" "admiral_varsha_u1804" {
#  ami = "${var.ami_us_east_1_ubuntu1804}"
#  availability_zone = "${var.avl-zone}"
#  instance_type = "${var.in_type_ms_x}"
#  key_name = "${var.aws_key_name}"
#  subnet_id = "${aws_subnet.sn_admiral_setup.id}"
...
#
#  tags = {
#    Name = "admiral_varsha_u1804_${count.index}_${var.install_version}"
#  }
#}
#
#output "admiral_varsha_u1804" {
#  value = "${formatlist("instance %v has private ip %v", aws_instance.admiral_varsha_u1804.*.id, aws_instance.admiral_varsha_u1804.*.private_ip)}"
#}
